...
execute store result score @s _ntrlSpwn.dmTp run data get entity @e[type=area_effect_cloud, tag=random_uuid, tag=random_demon, limit=1] UUIDLeast 0.00000000023283064365386962890625
