...
execute if entity @s[nbt={HurtTime:10s}] run data merge entity @e[type=armor_stand, tag=mountain_bug, limit=1, sort=nearest, distance=..1] {ArmorItems:[{},{},{},{id:"minecraft:nether_brick", Count:1b, tag:{CustomModelData:2110024}}]}
...
execute if entity @s[nbt={HurtTime:0s}] run data merge entity @e[type=armor_stand, tag=mountain_bug, limit=1, sort=nearest, distance=..1] {ArmorItems:[{},{},{},{id:"minecraft:nether_brick", Count:1b, tag:{CustomModelData:2110023}}]}
