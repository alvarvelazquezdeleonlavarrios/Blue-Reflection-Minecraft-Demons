...
execute as @e[type=zombie, tag=heavy_nose_bug, limit=1, sort=nearest] run data merge entity @s {CustomName:'{"text":"Heavy Nose Bug", "color": "#19B2FF"}'}
