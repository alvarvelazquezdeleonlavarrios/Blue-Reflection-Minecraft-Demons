...
execute as @e[type=zombie, tag=heavy_circlet, limit=1, sort=nearest] run data merge entity @s {CustomName:'{"text":"Heavy Circlet", "color": "#19B2FF"}'}
