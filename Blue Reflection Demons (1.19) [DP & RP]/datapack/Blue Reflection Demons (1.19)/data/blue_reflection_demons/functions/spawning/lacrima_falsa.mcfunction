...
execute as @e[type=zombie, tag=lacrima_falsa, limit=1, sort=nearest] run data merge entity @s {CustomName:'{"text":"Lacrima Falsa", "color": "#19B2FF"}'}
