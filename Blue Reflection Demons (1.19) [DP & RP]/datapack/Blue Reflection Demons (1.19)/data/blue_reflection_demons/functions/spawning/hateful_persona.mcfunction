...
execute as @e[type=zombie, tag=hateful_persona, limit=1, sort=nearest] run data merge entity @s {CustomName:'{"text":"Hateful Persona", "color": "#19B2FF"}'}
