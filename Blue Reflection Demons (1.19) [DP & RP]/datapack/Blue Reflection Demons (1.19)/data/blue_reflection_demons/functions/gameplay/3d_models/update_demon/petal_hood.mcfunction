...
#   armor_stand.model = ResourcePacks.Find("Blue Reflection Demons", nether_brick, 1705128);
...
#   armor_stand.model = ResourcePacks.Find("Blue Reflection Demons", nether_brick, 1705127);
