...
#   armor_stand.model = ResourcePacks.Find("Blue Reflection Demons", nether_brick, 1705114);
...
#   armor_stand.model = ResourcePacks.Find("Blue Reflection Demons", nether_brick, 1705113);
