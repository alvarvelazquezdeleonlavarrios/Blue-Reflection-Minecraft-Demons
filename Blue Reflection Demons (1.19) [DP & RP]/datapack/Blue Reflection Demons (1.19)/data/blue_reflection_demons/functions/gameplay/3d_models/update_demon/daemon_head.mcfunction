...
#   armor_stand.model = ResourcePacks.Find("Blue Reflection Demons", nether_brick, 1705086);
...
#   armor_stand.model = ResourcePacks.Find("Blue Reflection Demons", nether_brick, 1705085);
