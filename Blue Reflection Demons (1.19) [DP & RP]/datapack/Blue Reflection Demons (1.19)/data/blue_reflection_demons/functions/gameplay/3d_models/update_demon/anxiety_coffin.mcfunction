...
#   armor_stand.model = ResourcePacks.Find("Blue Reflection Demons", nether_brick, 1705118);
...
#   armor_stand.model = ResourcePacks.Find("Blue Reflection Demons", nether_brick, 1705117);
