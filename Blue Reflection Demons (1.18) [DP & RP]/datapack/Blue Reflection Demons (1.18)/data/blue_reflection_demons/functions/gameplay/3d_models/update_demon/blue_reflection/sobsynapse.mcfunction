...
execute if entity @s[nbt={HurtTime:10s}] run data merge entity @e[type=armor_stand, tag=sobsynapse, limit=1, sort=nearest, distance=..1] {ArmorItems:[{},{},{},{id:"minecraft:nether_brick", Count:1b, tag:{CustomModelData:1705048}}]}
...
execute if entity @s[nbt={HurtTime:0s}] run data merge entity @e[type=armor_stand, tag=sobsynapse, limit=1, sort=nearest, distance=..1] {ArmorItems:[{},{},{},{id:"minecraft:nether_brick", Count:1b, tag:{CustomModelData:1705047}}]}
