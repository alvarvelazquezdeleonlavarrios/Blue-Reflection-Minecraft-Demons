...
execute if entity @e[type=#blue_reflection_demons:hostile_mobs, tag=blue_reflection_demon] as @e[type=#blue_reflection_demons:hostile_mobs, tag=blue_reflection_demon] run data merge entity @s {active_effects:[{id:"minecraft:invisibility", amplifier:1b, duration:20, show_particles:0b}]}
#***********************************************************************************************
