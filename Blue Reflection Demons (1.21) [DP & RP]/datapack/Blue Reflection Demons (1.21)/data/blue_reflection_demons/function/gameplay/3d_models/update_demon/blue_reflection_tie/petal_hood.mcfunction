...
execute if entity @s[nbt={HurtTime:10s}] run data merge entity @e[type=armor_stand, tag=petal_hood, limit=1, sort=nearest, distance=..1] {ArmorItems:[{},{},{},{id:"minecraft:nether_brick", count:1b, components:{"minecraft:custom_model_data":2110026}}]}
...
execute if entity @s[nbt={HurtTime:0s}] run data merge entity @e[type=armor_stand, tag=petal_hood, limit=1, sort=nearest, distance=..1] {ArmorItems:[{},{},{},{id:"minecraft:nether_brick", count:1b, components:{"minecraft:custom_model_data":2110025}}]}
